const likesArr: string[] = [
  ...
  "climbing curtains",
  "collecting glass jars that I'll never use again",
  ...
  "doing the wiggly-butt before pouncing on an unsuspecting kernel of popcorn",
  ...
  "hallway purrkour",
  "ham sammiches",
  "hiding Mommy's Chapstick tubes",
...
const dislikesArr: string[] = [
  ...
  "going to the vet",
  "having the wrong sauce-to-vehicle ratio",
  "having to ask for napkins at a Dairy Queen drive-thru",
  "having to explain tax brackets",
  "herd mentality",
  "hidden fees",
  ...
  "updating my resume",
  "vacuum cleaners",
  "waiting for George R. R. Martin to release the next book",
  "water pistols",
  "weak-ass plumbing",
